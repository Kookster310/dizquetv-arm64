...
$timezone = "##TVTIMEZONE##";  // Set to your local timezone
$lineUpID = "##LINEUPID##";      // Set this to ID of the Line Up data you want to extract
$days     = 7;                   // Number of days worth of guide data to collect (8 days max)
